...
import sparrow.etl.core.security.CryptoUtil;
import sparrow.etl.core.util.Constants;
import sparrow.etl.core.util.KeyTransformerMap;
import sparrow.etl.core.util.SparrowUtil;
import sparrow.etl.core.util.TokenResolver;
import sparrow.etl.jaxb.MODULEType;
import sparrow.etl.jaxb.PARAMType;
	...
	private void bind(List paramTypes) {
		if (!paramTypes.isEmpty()) {
			for (Iterator iter = paramTypes.iterator(); iter.hasNext();) {
				...
				currentValue = (item.getVALUE()==null) ? item.getContent() : item.getVALUE();
				paramTable.put(currentKey, scanVars(currentValue,
