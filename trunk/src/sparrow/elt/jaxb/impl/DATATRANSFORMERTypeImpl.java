...
public class DATATRANSFORMERTypeImpl implements sparrow.elt.jaxb.DATATRANSFORMERType, com.sun.xml.bind.unmarshaller.UnmarshallableObject, com.sun.xml.bind.serializer.XMLSerializable, com.sun.xml.bind.validator.ValidatableObject
{
    ...
    public int getPOOLSIZE() {
        if (!has_POOLSIZE) {
            return com.sun.msv.datatype.xsd.IntType.load(com.sun.xml.bind.WhiteSpaceProcessor.collapse("25")).intValue();
        } else {
            return _POOLSIZE;
        }
    }
    ...
    public int getTHREADCOUNT() {
        if (!has_THREADCOUNT) {
            return com.sun.msv.datatype.xsd.IntType.load(com.sun.xml.bind.WhiteSpaceProcessor.collapse("5")).intValue();
        } else {
            return _THREADCOUNT;
        }
    }
    ...
    public com.sun.xml.bind.unmarshaller.ContentHandlerEx getUnmarshaller(com.sun.xml.bind.unmarshaller.UnmarshallingContext context) {
        return new sparrow.elt.jaxb.impl.DATATRANSFORMERTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        if (has_POOLSIZE) {
            context.startAttribute("", "POOL-SIZE");
            context.text(com.sun.msv.datatype.xsd.IntType.save(((Integer) new java.lang.Integer(_POOLSIZE))));
            context.endAttribute();
        }
        if (_CLASS!= null) {
        ...
        if (has_THREADCOUNT) {
            context.startAttribute("", "THREAD-COUNT");
            context.text(com.sun.msv.datatype.xsd.IntType.save(((Integer) new java.lang.Integer(_THREADCOUNT))));
            context.endAttribute();
        }
    }
    ...
    public Class getPrimaryInterface() {
        return (sparrow.elt.jaxb.DATATRANSFORMERType.class);
    }
        ...
        extends com.sun.xml.bind.unmarshaller.ContentHandlerEx
    {
        ...
        protected com.sun.xml.bind.unmarshaller.UnmarshallableObject owner() {
            return sparrow.elt.jaxb.impl.DATATRANSFORMERTypeImpl.this;
        }
            ...
            try {
                switch (state) {
                    case  1 :
                        ...
                        return ;
                    case  7 :
                        _THREADCOUNT = com.sun.msv.datatype.xsd.IntType.load(com.sun.xml.bind.WhiteSpaceProcessor.collapse(value)).intValue();
                        has_THREADCOUNT = true;
                        state = 8;
                        return ;
                    case  5 :
                    ...
                    case  0 :
                        ...
                        return ;
                    case  11 :
                        _POOLSIZE = com.sun.msv.datatype.xsd.IntType.load(com.sun.xml.bind.WhiteSpaceProcessor.collapse(value)).intValue();
                        has_POOLSIZE = true;
                        state = 12;
                        return ;
                    case  9 :
