...
public class SERVICESTypeImpl implements sparrow.elt.jaxb.SERVICESType, com.sun.xml.bind.unmarshaller.UnmarshallableObject, com.sun.xml.bind.serializer.XMLSerializable, com.sun.xml.bind.validator.ValidatableObject
{
    ...
    public com.sun.xml.bind.unmarshaller.ContentHandlerEx getUnmarshaller(com.sun.xml.bind.unmarshaller.UnmarshallingContext context) {
        return new sparrow.elt.jaxb.impl.SERVICESTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = _SERVICE.size();
        while (idx1 != len1) {
            context.startElement("", "SERVICE");
            int idx_0 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.serializer.XMLSerializable) _SERVICE.get(idx_0 ++)));
            context.endAttributes();
            context.childAsElements(((com.sun.xml.bind.serializer.XMLSerializable) _SERVICE.get(idx1 ++)));
            context.endElement();
        }
    }
    ...
    public Class getPrimaryInterface() {
        return (sparrow.elt.jaxb.SERVICESType.class);
    }
        ...
        extends com.sun.xml.bind.unmarshaller.ContentHandlerEx
    {
        ...
        protected com.sun.xml.bind.unmarshaller.UnmarshallableObject owner() {
            return sparrow.elt.jaxb.impl.SERVICESTypeImpl.this;
        }
            ...
            switch (state) {
                ...
                case  1 :
                    if ("".equals(___uri)&&"PARAM".equals(___local)) {
                        _SERVICE.add(((sparrow.elt.jaxb.impl.SERVICETypeImpl) spawnChildFromEnterElement((sparrow.elt.jaxb.impl.SERVICETypeImpl.class), 2, ___uri, ___local, __atts)));
                        return ;
                    }
                    break;
            }
            ...
            switch (state) {
                ...
                case  1 :
                    if ("".equals(___uri)&&"APP-NOTIFICATION".equals(___local)) {
                        _SERVICE.add(((sparrow.elt.jaxb.impl.SERVICETypeImpl) spawnChildFromEnterAttribute((sparrow.elt.jaxb.impl.SERVICETypeImpl.class), 2, ___uri, ___local)));
                        return ;
                    }
