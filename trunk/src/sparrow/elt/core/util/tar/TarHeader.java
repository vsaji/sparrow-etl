...
public
   ...
   */
  public static long
      parseOctal(byte[] header, int offset, int length) throws
   ...
   */
  public static StringBuffer
      parseName(byte[] header, int offset, int length) throws
      InvalidHeaderException {
   ...
   */
  public static int
      getFileNameBytes(String newName, byte[] outbuf) throws
      InvalidHeaderException {
