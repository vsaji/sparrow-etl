...
public class DATAWRITERSTypeImpl
    implements sparrow.elt.jaxb.DATAWRITERSType,
  ...
  private final static Class PRIMARY_INTERFACE_CLASS = sparrow.elt.jaxb.
      DATAWRITERSType.class;
  protected java.util.ArrayList _WRITER = new java.util.ArrayList();
  protected String _ONERROR;
  ...
  public int getTHREADCOUNT() {
      if (!has_THREADCOUNT) {
          return com.sun.msv.datatype.xsd.IntType.load(com.sun.xml.bind.WhiteSpaceProcessor.collapse("1")).intValue();
      } else {
          return _THREADCOUNT;
      }
  }
  ...
  public com.sun.xml.bind.unmarshaller.ContentHandlerEx getUnmarshaller(com.sun.
    ...
    return new sparrow.elt.jaxb.impl.DATAWRITERSTypeImpl.Unmarshaller(
        context);
  }
  ...
  public Class getPrimaryInterface() {
    return (sparrow.elt.jaxb.DATAWRITERSType.class);
  }
  ...
  public class Unmarshaller
    ...
    protected com.sun.xml.bind.unmarshaller.UnmarshallableObject owner() {
      return sparrow.elt.jaxb.impl.DATAWRITERSTypeImpl.this;
    }
      ...
      switch (state) {
        ...
        case 1:
          if ("".equals(___uri) && "PARAM".equals(___local)) {
            _WRITER.add( ( (sparrow.elt.jaxb.impl.WRITERTypeImpl)
                          spawnChildFromEnterElement( (sparrow.elt.jaxb.impl.WRITERTypeImpl.class), 2, ___uri, ___local, __atts)));
            return;
          }
          break;
      }
    ...
    public void enterAttribute(String ___uri, String ___local) throws com.sun.
      ...
      switch (state) {
        case 3:
          if ("".equals(___uri) && "ON-ERROR".equals(___local)) {
            state = 6;
            return;
          }
        ...
        case 1:
          if ("".equals(___uri) && "NAME".equals(___local)) {
            _WRITER.add( ( (sparrow.elt.jaxb.impl.WRITERTypeImpl)
                          spawnChildFromEnterAttribute( (sparrow.elt.jaxb.impl.WRITERTypeImpl.class), 2, ___uri, ___local)));
            return;
          }
      ...
      try {
        switch (state) {
          ...
          case 6:
            ...
            return;
          case 4:
            _THREADCOUNT = com.sun.msv.datatype.xsd.IntType.load(com.sun.xml.
    ...
    private void goto3() throws com.sun.xml.bind.unmarshaller.
      ...
      int idx;
      state = 3;
      idx = context.getAttribute("", "ON-ERROR");
      if (idx >= 0) {
